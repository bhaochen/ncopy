          ...
          {onSettings !== undefined && (
            <Tooltip label="Settings">
              <button
                ...
                onClick={onSettings}
                aria-label="Settings"
                className="w-7 h-7 flex items-center justify-center rounded-lg transition-colors duration-150 cursor-pointer text-text-secondary hover:text-primary hover:bg-primary/8"
              >
                {SETTINGS_ICON}
              </button>
            </Tooltip>
